...
const CalendarChild2 = (props) => {
    ...
    <>
      <div className="row">
        <div className="d-flex">
          <h2 className="">
            <BsNewspaper /> 症狀勾選{' '}
            <h5 className="mt-3">讓我們替您記住身體的大小事</h5>
          </h2>
      ...
      <div class="row d-flex justify-content-end">
        <div className="">
          <button
            className="btn-soft-green mt-auto "
            onClick={() => {
              setCalStepChild(2)
            }}
          >
  ...
  const ChildPart2 = (
    <>
      ...
      {displaySymptom.length &&
        displaySymptom.map((s, i) => {
          return (
            <div class="container">
              <div className="row">
                <div className="card" style={{ width: '50rem' }}>
                  <div className="symptomImgWrap">
                    <img
                      className="card-img-top symptomImg"
                      src={`/img/Calendar/${s.SymptomImg}`}
                      alt="Card image cap"
                    />
                  </div>
      ...
      <div className="row">
        <img
          src="/img/Index/calligraphy002.svg"
          alt="StayTrue"
  ...
  return (
    <div>
      ...
      <div className="container">{switchChildSteps(calStepChild)}</div>
      <Footer />
    </div>
  )
}
